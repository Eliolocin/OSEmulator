...
void ScreenS(String processName, GlobalScheduler* scheduler)
{
	...
	auto newProcess = std::make_shared<Process>(processName, consolesPresent, processMemReq, frameSize); // PID Naming Convention: Number of Consoles/Processes present + 1
